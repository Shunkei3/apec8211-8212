...
For further infromation about R markdown see the document "Using-R-Markdown.pdf". 
...
+ Let's write some math equations using LaTeX math notations on your `.Rmd` (or `.rmd`) file and see it's correctly appeared on a PDF document. 
