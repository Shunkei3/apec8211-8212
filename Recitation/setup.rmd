...
# opts_knit$set(root.dir = "/Users/tmieno2/Dropbox/ConferencePresentation/Presentation/2021/Kobe_University")
```
...
```{r tmap-layout, echo=F, cache = FALSE}
tm_layout_to_add <-
  tm_layout(
    legend.outside = "TRUE",
    frame = FALSE,
...
```{r figure_setup, echo=F, cache = F, eval=F}
theme_update(
  axis.title.x =
    element_text(
...
.remark-code, .remark-inline-code { 
  font-family: 'Source Code Pro', 'Lucida Console', Monaco, monospace;font-size: 90%;
}
