...
$X \perp \!\!\! \perp e \iff f(D, e) = f(D)f(e)$

**Verbally**: $e$ can tell nothing about $X$, vice versa
...
+ Meanwhile, if $e$ is mean independent of $X$, that means the mean of the distribution of $e$ does not depend on the value of $X$. Whatever the value of $X$ is, the mean of $e$ does not change. 

+ and, if $e$ and $X$ are uncorrelated, 

+ By the way, is it okay about why $E[Xe]=0$ means uncorrelatedness between $X$ and $e$? Can anyone explain?
