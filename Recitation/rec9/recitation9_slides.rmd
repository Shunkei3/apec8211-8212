...
.small[
Suppose you have  
$$Y=\hat{\beta_0}+\hat{\beta}_1 X_1+ \hat{\beta}_2 X_2 + \hat{\beta_3} X_3 + e$$
...
=
\begin{bmatrix}
[\hat{V}_{\hat{\beta}}]_{11} & [\hat{V}_{\hat{\beta}}]_{12} & [\hat{V}_{\hat{\beta}}]_{13} & [\hat{V}_{\hat{\beta}}]_{14} \\
[\hat{V}_{\hat{\beta}}]_{21} & [\hat{V}_{\hat{\beta}}]_{22} & [\hat{V}_{\hat{\beta}}]_{23} & [\hat{V}_{\hat{\beta}}]_{24}\\
[\hat{V}_{\hat{\beta}}]_{31} & [\hat{V}_{\hat{\beta}}]_{32} & [\hat{V}_{\hat{\beta}}]_{33} & [\hat{V}_{\hat{\beta}}]_{34}\\
[\hat{V}_{\hat{\beta}}]_{41} & [\hat{V}_{\hat{\beta}}]_{42} & [\hat{V}_{\hat{\beta}}]_{43} & [\hat{V}_{\hat{\beta}}]_{44}
\end{bmatrix}.$$

$[\hat{V}_{\hat{\beta}}]_{ij}$ means $(i,j)$ element of $\hat{\mathbf{V}}_{\hat{\beta}}$.
...
\hat{V}_{\hat{\theta}}
  ...
  &= [\hat{V}_{\hat{\beta}}]_{22}+[\hat{V}_{\hat{\beta}}]_{33}+2[\hat{V}_{\hat{\beta}}]_{23}
\end{align*}$$

.small[
NOTE: According to the notation of $\hat{V}_{\hat{\beta}}$, for example, $\widehat{Var}[\hat{\beta}_1]$ corresponds to $(2,2)$ element of $\hat{\mathbf{V}}_{\hat{\beta}}$.
]
