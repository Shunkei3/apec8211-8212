...
# Mean and Variance and Jensen's inequality
...
We want to derive the PDF of $Y$ which is defined by $Y=X^2$. Since $0 \leq X \leq 1$, $0 \leq Y \leq 1$. Recall the definition of PDF. Let $G(y)$ be the CDF of Y and $g(y)$ be the PDF of Y. Then, $g(y)=\frac{d}{dy}G(y)$ by the definition of PDF. So, once you get $G(y)$, you can derive $g(y)$. So, let's consider the CDF of $Y$.
