...
In our case, the outcome is the number of heads ($X$), we use it to "estimate" true parameters <span style="color:blue">$E[X]=3$</span> and <span style="color:blue">$Var[X]=2$</span>. 
...
If the underlying data-generating process is nonlinear (e.g., the impact of precipitation on crop yield), aggregation (field-year level to county-level data) might mask the true relationship. 
